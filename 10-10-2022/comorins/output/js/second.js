...
function disp(){
    ...
    ele2=ele2+"<a href='third.html?name="+list[i].id+"' id='ad' onclick='cart("+i+")'> <button class='px-5 py-3 d-inline but atc' >ADD TO CART</button></a> <a href='placeorder.html' id='ad2'><button class='px-5 py-3 float-right d-inline but bn' onclick='add_orders("+i+")'>BUY NOW</button></a>"
